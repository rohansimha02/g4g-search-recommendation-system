...
def load_articles_data():
    ...
    try:
        ...
        data_paths = [
            os.getenv("DATA"),
            "./backend-data/geeksforgeeks_articles.csv",
            "./data/geeksforgeeks_articles.csv",
            "backend-data/geeksforgeeks_articles.csv",
            "data/geeksforgeeks_articles.csv",
            "./flask-server/data/geeksforgeeks_articles.csv",
            os.path.join(os.path.dirname(__file__), "backend-data", "geeksforgeeks_articles.csv"),
...
def initialize_bm25_background():
    try:
        ...
        index_paths = [
            "./backend-data/geek_index/data.properties",
            "./data/geek_index/data.properties",
            "backend-data/geek_index/data.properties", 
            "data/geek_index/data.properties",
            "../data/geek_index/data.properties",
            "./flask-server/data/geek_index/data.properties",
            os.path.join(os.path.dirname(__file__), "backend-data", "geek_index", "data.properties"),
